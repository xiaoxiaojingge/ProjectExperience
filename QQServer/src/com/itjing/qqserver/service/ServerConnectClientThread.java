package com.itjing.qqserver.service;
...
public class ServerConnectClientThread extends Thread {
    ...
    public void run() { //这里线程处于run的状态，可以发送/接收消息
        ...
        while (true) {
            try {
                System.out.println("服务端线程，服务端和客户端" + userId + " 保持通信，读取数据...");
                ...
                if (message.getMessageType().equals(MessageType.MESSAGE_GET_ONLINE_FRIEND)) {
                    ...
                    mes.setMessageType(MessageType.MESSAGE_RET_ONLINE_FRIEND);
                    mes.setContent(onlineUser);
                    mes.setReceiver(message.getSender());
                    //返回给客户端
